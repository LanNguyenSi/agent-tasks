...
//      every required signal for the type MUST still fire. This is the
//      regression guard for the dropped alternatives: e.g. security's junk
//      fixture below contains the bare word "risk", which the PRE-tightening
//      `\brisks?\b` alternative would have wrongly accepted as satisfying
//      missing_threat_or_risk.
