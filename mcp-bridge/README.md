...
see [`mcp-server/README.md`](../mcp-server/README.md#tools) for the full
list and their v2 replacements). Set `AGENT_TASKS_MCP_LEGACY=1` in the
bridge process's environment to register all 37 tools instead:
